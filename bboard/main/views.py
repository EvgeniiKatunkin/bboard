...
class BBPasswordChangeView(SuccessMessageMixin, LoginRequiredMixin, PasswordChangeView):
    ...
    success_message = "User's password has been changed"
...
class ChangeUserInfoView(SuccessMessageMixin, LoginRequiredMixin, UpdateView):
    ...
    success_url = reverse_lazy('main:profile')
    success_message = "User's data has been changed"
...
def profile_bb_add(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if formset.is_valid():
                formset.save()
                messages.add_message(request, messages.SUCCESS, 'Bulletin has been added.')
...
def profile_bb_change(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if formset.is_valid():
                formset.save()
                messages.add_message(request, messages.SUCCESS, 'Bulletin has been adjusted.')
                return redirect('main:profile')
    else:
...
def profile_bb_delete(request, pk):
    ...
    if request.method == 'POST':
        bb.delete()
        messages.add_message(request, messages.SUCCESS, 'Bulletin has been deleted.')
        return redirect('main:profile')
    else:
        context = {'bb': bb}
